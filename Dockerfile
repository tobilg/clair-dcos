...
RUN mkdir -p $CLAIR_DCOS_PATH && \
    wget -qO- https://github.com/jwilder/dockerize/releases/download/v0.4.0/dockerize-linux-amd64-v0.4.0.tar.gz | tar xvz -C /usr/local/bin
